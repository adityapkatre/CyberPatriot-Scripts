...
lockPref("extensions.update.enabled", false);
	...
	//lockPref("security.ssl3.rsa_aes_256_sha",                        false); // 0x35
	

	//lockPref("security.ssl3.rsa_aes_128_sha",                        false); // 0x2f
	

	//lockPref("security.ssl3.ecdhe_rsa_aes_256_sha",                false); // 0xc014
	

	//lockPref("security.ssl3.ecdhe_ecdsa_aes_256_sha",                false); // 0xc00a